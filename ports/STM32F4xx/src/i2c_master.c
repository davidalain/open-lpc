...
//
//	i2c_init.I2C_ClockSpeed = i2c_clk;
//
...
//
//	scl_hl = pclk / i2c_clk;
//	i2c_init = (LPC_I2C_TypeDef *) i2c->i2c;
//	i2c_init->I2SCLH = scl_hl / 2;
//	i2c_init->I2SCLL = (scl_hl - i2c_init->I2SCLH); // Coloca o I2C com 50% de duty no clock
}
...
uint32_t i2cmaster_read(const i2cmaster_t *i2c, uint8_t address, uint8_t *data,
		uint32_t length) {
...
//			;  // Espera ficar pronto para transmitir
...
uint32_t i2cmaster_write(const i2cmaster_t *i2c, uint8_t address,
